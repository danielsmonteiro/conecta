...
|---|---|---|
| Lógica | Reduzir o custo do gap dentro da Coaph | Escalar a camada de contingência para outras cooperativas/hospitais |
| Métrica | Economia operacional mensal | Receita recorrente (SaaS de prontidão + fee) |
